...
--component
Component   = require ("Frame.LoveEngine.Component.Component")
Transform   = require ("Frame.LoveEngine.Component.Transform")
Image       = require ("Frame.LoveEngine.Component.Image")
